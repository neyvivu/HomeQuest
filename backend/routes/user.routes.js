...
import { changePass, updateAgent, updateCustomer, updateInvestor, updateProfiePic ,resetPassword, getAgent, addToWatchList, deleteFromWatchList} from "../controllers/user.controller.js";
...
router.put("/update/Investor", updateInvestor);
